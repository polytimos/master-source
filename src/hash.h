...
#include "obj/sph_skein.h"
#include "obj/sph_shabal.h"
#include "obj/sph_echo.h"
#include "obj/sph_luffa.h"
#include "obj/sph_fugue.h"
#include "obj/sph_gost.h"
...
inline uint256 Spartan(const T1 pbegin, const T1 pend)

{
    ...
    sph_shabal512 (&ctx_shabal, static_cast<const void*>(&hash[0]), 64);
    sph_shabal512_close(&ctx_shabal, static_cast<void*>(&hash[1]));
    ...
    sph_luffa512 (&ctx_luffa, static_cast<void*>(&hash[2]), 64);
