...
#if defined(NDEBUG)
# error "Polytimos cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Polytimos Signed Message:\n";
...
unsigned int GetNextTargetRequired(const CBlockIndex* pindexLast, bool fProofOfStake)
{
    ...
    else if (pindexLast->nHeight < 800000)
...
{
    RenameThread("polytimos-loadblk");
