# Mac OS X Polytimosd Build Instructions
...
* See readme-qt.rst for instructions on building Polytimos QT, the
...
## Building Polytimos
    ...
    git clone https://github.com/polytimosd/source polytimos
    cd polytimos/src
    make -f makefile.osx

## Useful commands

    ./polytimosd --help  # for a list of command-line options.
    ./polytimosd -daemon # to start the polytimos daemon.
    ./polytimosd help    # When the daemon is running, to get a list of RPC commands
